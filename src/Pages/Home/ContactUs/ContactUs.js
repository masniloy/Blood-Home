    ...
    return (
        <div data-aos="fade-up" className='stats w-full max-w-7xl'>
            <div className=' bg-red-100 p-5 stats-vertical' >
                <h1 className='text-2xl text-left font-bold mb-3'>Feedback</h1>
 ...
 */}
                ...
                <input type="email" placeholder="Email" className="input input-sm my-2 input-bordered  w-full max-w-2xl drop-shadow-md" /><br />
